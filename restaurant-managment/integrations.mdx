---
title: Integrations
description: ServeStream integrates with Square and Clover to streamline restaurant operations. Below are the steps to add a POS Integration and sync menus.
---

## Adding a new POS Integration

1. Navigate to **Restaurant Management** in the ServeStream dashboard.
2. Click **Integration** to initiate a new POS Integration setup.
