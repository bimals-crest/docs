...
description: ServeStream allows seamless syncing of menu items with Square, as well as editing and managing these items in your platform.
---
...
To use images hosted on Cloudflare's R2 storage for your menu items, note that Cloudflare offers a free tier that supports a limited number of images. The free tier should be sufficient for approximately 200 images, after which additional charges may apply. 
Follow these steps:
